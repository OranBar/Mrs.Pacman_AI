 ...
 * 3. Go to the nearest pill/power pill -- No, fuck power pills
 */
public class StarterPacmanV2 extends Controller<MOVE>
{	
	private int min_distance = 15;	//if a ghost is this close, run away
	
	public StarterPacmanV2(){
		
	}
	
	public StarterPacmanV2(int minDistance){
	...
	private void preMove(Game game) {
		//System.out.println("Blinky is at "+game.getGhostCurrentNodeIndex(GHOST.BLINKY)+", his last move was "+game.getGhostLastMoveMade(GHOST.BLINKY));
	}
}
