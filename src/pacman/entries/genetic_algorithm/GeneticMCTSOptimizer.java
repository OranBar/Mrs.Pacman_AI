...
import pacman.entries.pacman.TheRealMCTSPacman;
...
public class GeneticMCTSOptimizer extends GeneticAlgorithm{
	...
	public static void main(String[] args) {
		...
		*/
		...
		GeneticMCTSOptimizer ge = new GeneticMCTSOptimizer(1, 10);//, seed.subList(0, 5) );
		Gene result = ge.runGeneticAlgorithm(1);
